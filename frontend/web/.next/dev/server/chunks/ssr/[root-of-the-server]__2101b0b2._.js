...
"[project]/Desktop/Nmims/DeadMan Protocol/frontend/web/node_modules/secrets.js-grempe/secrets.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

// @preserve author Alexander Stetsyuk
// @preserve author Glenn Rempe <glenn@rempe.us>
// @license MIT
/*jslint passfail: false, bitwise: true, nomen: true, plusplus: true, todo: false, maxerr: 1000 */ /*global define, require, module, exports, window, Uint32Array */ // eslint : http://eslint.org/docs/configuring/
/*eslint-env node, browser, jasmine */ /*eslint no-underscore-dangle:0 */ // UMD (Universal Module Definition)
...
(function(root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        ...
        ((r)=>r !== undefined && __turbopack_context__.v(r))(function() {
            /*eslint-disable no-return-assign */ return root.secrets = factory();
        /*eslint-enable no-return-assign */ }());
    } else if ("TURBOPACK compile-time truthy", 1) {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(__turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"));
    } else //TURBOPACK unreachable
    ;
})(/*TURBOPACK member replacement*/ __turbopack_context__.e, function(crypto) {
    "use strict";
    ...
    function hasCryptoGetRandomValues() {
        if (crypto && typeof crypto === "object" && (typeof crypto.getRandomValues === "function" || typeof crypto.getRandomValues === "object") && (typeof Uint32Array === "function" || typeof Uint32Array === "object")) {
            return true;
        }
        return false;
    }
    ...
    var secrets = {
        ...
        combine: function(shares, at) {
            var i, j, len, len2, result = "", setBits, share, splitShare, x = [], y = [];
            at = at || 0;
        ...
        newShare: function(id, shares) {
            ...
            if (id && radid && shares && shares[0]) {
                ...
                return constructPublicShareString(share.bits, radid, this.combine(shares, id));
            }
            throw new Error("Invalid 'id' or 'shares' Array argument to newShare().");
        },
        /* test-code */ // export private functions so they can be unit tested directly.
        _reset: reset,
        _padLeft: padLeft,
        _hex2bin: hex2bin,
        _bin2hex: bin2hex,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2101b0b2._.js.map