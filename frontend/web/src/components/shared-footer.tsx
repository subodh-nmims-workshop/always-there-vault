...
export function SharedFooter() {
    ...
    return (
        <footer className="py-12 bg-slate-50 dark:bg-[#0a0c10] text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-white/5 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-slate-200 dark:border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
