...
export default function InvestorsPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0c12] text-slate-800 dark:text-white overflow-hidden selection:bg-[#2b52ff]/30">
      ...
      <div className="relative pt-40 pb-20 px-6 z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter leading-tight text-slate-900 dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="mailto:subodhram3350@gmail.com?subject=Developer Application - AlwaysThere">
              <Button variant="outline" className="h-14 px-8 bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-900 dark:text-white rounded-2xl font-black text-sm uppercase tracking-widest">
      ...
      <section className="py-24 px-6 border-y border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.01] relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="space-y-6">
            <div className="w-12 h-12 rounded-2xl bg-red-500/10 flex items-center justify-center border border-red-500/20">
              <Globe className="w-6 h-6 text-red-500" />
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-white">The $100 Billion Problem</h2>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl font-black text-slate-900 dark:text-white">The AlwaysThere Solution</h2>
            <p className="text-slate-700 dark:text-slate-400 leading-relaxed text-lg">
      ...
      <section className="py-24 px-6 relative z-10 max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white">Target Market</h2>
          <p className="text-slate-600 dark:text-slate-400 font-medium max-w-2xl mx-auto">Our protocol serves a rapidly expanding demographic of digital natives.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="p-8 rounded-3xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:border-slate-400 dark:hover:border-white/10 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-slate-100 dark:bg-white/5 flex items-center justify-center border border-slate-200 dark:border-white/10 mb-6">
                {item.icon}
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">{item.title}</h3>
              <p className="text-slate-700 dark:text-slate-400 leading-relaxed text-sm">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 px-6 relative z-10 bg-gradient-to-b from-transparent to-[#2b52ff]/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Investor Card */}
          <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-slate-50 to-slate-100 dark:from-[#0f121d] dark:to-[#0a0c12] border border-slate-200 dark:border-white/5 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-3xl font-black text-slate-900 dark:text-white">Fund the Next Unicorn</h3>
              ...
              <Link href="mailto:subodhram3350@gmail.com?subject=Investor Pitch Request" className="inline-block pt-6">
                <Button className="bg-slate-900 text-white dark:bg-white dark:text-black hover:bg-slate-800 dark:hover:bg-slate-200 rounded-xl font-bold gap-2">
          ...
          {/* Developer Card */}
          <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-slate-50 to-slate-100 dark:from-[#120f1d] dark:to-[#0a0c12] border border-slate-200 dark:border-white/5 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-3xl font-black text-slate-900 dark:text-white">Build with the Best</h3>
              <p className="text-slate-700 dark:text-slate-400">
              ...
              <Link href="mailto:subodhram3350@gmail.com?subject=Developer Application" className="inline-block pt-6">
                <Button className="bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-bold gap-2">
      ...
      {/* FOOTER */}
      <footer className="py-12 border-t border-slate-200 dark:border-white/5 text-center relative z-10 bg-slate-50 dark:bg-[#0a0c12]">
