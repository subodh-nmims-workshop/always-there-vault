...
export default function InvestorsPage() {
  return (
    <div className="min-h-screen bg-[#0a0c12] text-white overflow-hidden selection:bg-[#2b52ff]/30">
      ...
      <section className="py-24 px-6 border-y border-white/5 bg-white/[0.01] relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl font-black">The $100 Billion Problem</h2>
      ...
      <section className="py-24 px-6 relative z-10 max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          <h2 className="text-3xl md:text-5xl font-black">Target Market</h2>
          <p className="text-slate-400 font-medium max-w-2xl mx-auto">Our protocol serves a rapidly expanding demographic of digital natives.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-colors">
      ...
      <section className="py-24 px-6 relative z-10 bg-gradient-to-b from-transparent to-[#2b52ff]/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Investor Card */}
          <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-[#0f121d] to-[#0a0c12] border border-white/5 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-3xl font-black">Fund the Next Unicorn</h3>
              ...
              <Link href="mailto:subodhram3350@gmail.com?subject=Investor Pitch Request" className="inline-block pt-6">
                <Button className="bg-white text-black hover:bg-slate-200 rounded-xl font-bold gap-2">
          ...
          {/* Developer Card */}
          <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-[#120f1d] to-[#0a0c12] border border-white/5 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-3xl font-black">Build with the Best</h3>
              <p className="text-slate-400">
