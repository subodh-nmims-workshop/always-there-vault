    ...
    <div className="w-full dark:text-slate-900 dark:text-white overflow-hidden selection:bg-[#2b52ff]/30 bg-transparent text-slate-800 dark:text-slate-100">
      ...
      <div className="relative pt-40 pb-20 px-6 z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-650 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="mailto:support@alwaystherevault.com?subject=Developer Application - AlwaysThere">
              <Button variant="outline" className="h-14 px-8 bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-800 dark:text-white rounded-2xl font-black text-sm uppercase tracking-widest">
              ...
              <ul className="space-y-3 pt-4">
                {['High-margin SaaS subscription model', 'First-mover advantage in decentralized estate planning', 'Scalable B2B APIs for enterprise integration'].map((text, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-slate-750 dark:text-slate-300 font-medium">{text}</span>
                  </li>
                ))}
              </ul>
