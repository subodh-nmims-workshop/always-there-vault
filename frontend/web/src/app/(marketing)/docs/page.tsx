...
export default function DocsPage() {
  return (
    <div className="w-full dark:text-slate-200 font-sans selection:bg-blue-500/30 bg-transparent text-slate-800 dark:text-slate-100">
        ...
        <div className="space-y-32">
          ...
          <section id="architecture" className="scroll-mt-24">
            <div className="flex items-center gap-4 mb-10">
              ...
              <h2 className="text-3xl font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight">01. Hybrid Storage Engine</h2>
            </div>
            <div className="bg-slate-50 dark:bg-slate-50 dark:bg-white/[0.02] rounded-[2.5rem] p-10 border border-slate-200 dark:border-slate-200 dark:border-white/5 space-y-8">
              <p className="text-slate-600 dark:text-slate-600 dark:text-slate-400 leading-relaxed font-medium text-lg">
                AlwaysThere utilizes a <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold italic">Dual-Layer Storage Architecture</span> to balance instant accessibility with eternal persistence.
              </p>

              <div className="space-y-6">
                <div className="flex gap-6 p-6 bg-slate-100 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-slate-200 dark:border-white/5">
                  ...
                  <div>
                    <h4 className="font-black text-slate-900 dark:text-slate-900 dark:text-white mb-2 uppercase text-sm tracking-widest">Layer 1: Performance (Cloudflare R2)</h4>
          ...
          <section id="security" className="scroll-mt-24">
            <div className="flex items-center gap-4 mb-10">
              ...
              <h2 className="text-3xl font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight">02. Encryption Workflow</h2>
            </div>
            <div className="space-y-8">
              ...
              <div className="p-8 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-slate-200 dark:border-white/10 rounded-3xl">
                <h4 className="font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white mb-4 uppercase text-xs tracking-[0.3em]">The Data Journey:</h4>
          ...
          <section id="heartbeat" className="scroll-mt-24">
            <div className="flex items-center gap-4 mb-10">
              ...
              <h2 className="text-3xl font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight">03. The Heartbeat Logic</h2>
            </div>
            <div className="bg-slate-900 dark:bg-[#0f172a] rounded-[3rem] p-12 border border-blue-500/20">
              <p className="text-slate-750 dark:text-slate-300 font-bold mb-10 text-xl italic">"Autonomous execution is the ultimate trust."</p>
          ...
          <section id="privacy" className="scroll-mt-24">
            <div className="text-center p-16 bg-white/5 rounded-[3rem] border border-slate-200 dark:border-white/10">
              <Shield className="w-16 h-16 text-blue-500 mx-auto mb-6" />
              <h3 className="text-2xl font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase mb-4">PRIVACY BY DESIGN</h3>
...
function DocFeatureCard({ title, desc }: any) {
  return (
    <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-slate-200 dark:border-white/5">
      <h4 className="font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase text-xs mb-2 tracking-widest">{title}</h4>
...
function JourneyStep({ step, label, desc }: any) {
  return (
    <div className="flex items-center gap-4">
      <span className="w-6 h-6 rounded bg-blue-600 flex items-center justify-center text-[10px] font-black text-slate-900 dark:text-white">{step}</span>
      <div className="flex flex-col">
        <span className="text-[10px] font-black text-slate-800 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-widest">{label}</span>
...
function LogicBlock({ title, desc }: any) {
  return (
    <div className="border-l-2 border-blue-500 pl-8 space-y-2">
      <h4 className="font-black text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight">{title}</h4>
      <p className="text-sm text-slate-600 dark:text-slate-600 dark:text-slate-400 leading-relaxed font-medium">{desc}</p>
    </div>
  )
}
