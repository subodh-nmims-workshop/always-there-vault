...
export default function SecurityPolicyPage() {
    return (
        <div className="min-h-screen bg-white dark:bg-[#050a1a] font-sans selection:bg-[#2b52ff]/30 selection:text-white relative overflow-hidden flex flex-col text-slate-800 dark:text-slate-100">

            {/* Navigation */}
            <nav className="sticky top-0 z-50 bg-white/80 dark:bg-[#050a1a]/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 px-4 sm:px-8 py-4 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-3 group">
                    <div className="text-[#2b52ff] flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Shield className="w-8 h-8" />
                    </div>
                    <span className="font-bold text-xl tracking-tight hidden sm:block text-slate-900 dark:text-white">Always There Security</span>
                </Link>
                <div className="hidden md:flex gap-8 items-center absolute left-1/2 -translate-x-1/2">
                    ...
                    <Link href="/security" className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors text-sm font-medium">Platform Security</Link>
                    <Link href="/security-policy" className="text-slate-900 dark:text-white transition-colors text-sm font-medium">Bounty Program</Link>
                </div>
            ...
            <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-24 pb-32">
                ...
                <div className="prose prose-invert prose-red max-w-none space-y-12">
                    ...
                    <section className="bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                        ...
                        <div className="flex items-center mb-6 relative z-10">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white m-0">The $100,000 Bug Bounty Program</h2>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 relative z-10">
                            <div className="bg-white dark:bg-[#050a1a] border border-red-200 dark:border-red-900/50 p-6 rounded-2xl relative shadow-[0_0_15px_rgba(239,68,68,0.1)]">
                                <div className="absolute top-0 right-0 bg-red-900/50 text-red-200 text-xs font-bold px-3 py-1 rounded-bl-lg">CRITICAL</div>
                                <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Up to $100,000</h3>
                            ...
                            <div className="bg-white dark:bg-[#050a1a] border border-orange-200 dark:border-orange-900/50 p-6 rounded-2xl relative">
                                <div className="absolute top-0 right-0 bg-orange-900/50 text-orange-200 text-xs font-bold px-3 py-1 rounded-bl-lg">HIGH</div>
                                <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Up to $25,000</h3>
                                <p className="text-sm text-slate-400">Paid in USDC/ETH</p>
                                <ul className="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                    ...
                    <section className="bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-12">
                        <div className="flex items-center mb-6">
                            <Lock className="h-8 w-8 text-blue-400 mr-4" />
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white m-0">Safe Harbor Protocol</h2>
                        </div>
                        ...
                        <h4 className="font-bold text-slate-900 dark:text-white mb-2 mt-6">You must strictly adhere to the following:</h4>
                        <ul className="list-disc pl-6 space-y-3 text-slate-700 dark:text-slate-300 mb-6">
                    ...
                    <section className="bg-slate-50 dark:bg-[#050a1a] border-2 border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-12 text-center">
                        <Mail className="h-12 w-12 text-slate-400 mx-auto mb-6" />
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">How to Submit a Report</h2>
                        <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-8 max-w-xl mx-auto">
                        ...
                        <div className="bg-slate-900 p-6 rounded-xl inline-block text-left border border-slate-800 max-w-md w-full mb-8">
                            ...
                            <p className="text-lg font-mono text-slate-900 dark:text-white mb-4">security@digitalwill.protocol</p>
