        ...
        <div className="w-full font-sans text-slate-800 dark:text-slate-100 selection:bg-[#1152d4]/30 overflow-x-hidden relative transition-colors duration-300">
            ...
            <main className="flex-1 flex flex-col relative w-full items-center">
                ...
                <header className="relative pt-24 pb-16 px-6 text-center w-full max-w-5xl">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={defaultTransition} className="inline-flex items-center bg-slate-100 dark:bg-white/[0.03] backdrop-blur-md px-4 py-1.5 rounded-full border border-red-500/30 mb-6">
                ...
                <div className="space-y-24 px-6 pb-32 max-w-5xl w-full">
                    ...
                    <section className="grid md:grid-cols-2 gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-2 md:order-1 space-y-6">
                            ...
                            <ul className="space-y-3 pt-2">
                                <li className="flex items-center text-sm font-medium text-slate-700 dark:text-slate-300"><CheckCircle2 className="w-4 h-4 mr-3 text-red-500" /> WebCrypto Subsystem Isolation</li>
                                <li className="flex items-center text-sm font-medium text-slate-700 dark:text-slate-300"><CheckCircle2 className="w-4 h-4 mr-3 text-red-500" /> Ephemeral Memory Wipes post-encryption</li>
                            </ul>
                        </motion.div>

                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-1 md:order-2 bg-slate-50 dark:bg-white/[0.02] backdrop-blur-md rounded-2xl p-6 font-mono text-sm text-slate-700 dark:text-slate-400 overflow-hidden border border-slate-200 dark:border-white/5 shadow-2xl relative group hover:border-red-500/30 transition-colors">
                            ...
                            <pre className="opacity-90 overflow-x-auto leading-loose text-slate-800 dark:text-slate-300"><code>
                    ...
                    {/* Section 2 */}
                    <section className="grid md:grid-cols-2 gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-slate-50 dark:bg-white/[0.02] backdrop-blur-md aspect-square max-h-[400px] rounded-3xl flex items-center justify-center relative overflow-hidden border border-slate-200 dark:border-[#1152d4]/20 shadow-2xl">
                    ...
                    <section className="relative pt-16">
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-slate-50 dark:bg-white/[0.03] backdrop-blur-xl p-12 rounded-[3rem] border border-slate-200 dark:border-white/10 text-center overflow-hidden relative shadow-2xl">
                            ...
                            <h2 className="text-4xl font-black mb-6 relative z-10 tracking-tight text-slate-900 dark:text-white">Trust Math, Not Humans.</h2>
                    ...
                    <section className="mt-32 border-t border-slate-200 dark:border-white/10 pt-20">
                        <div className="max-w-4xl mx-auto space-y-12">
                            <div className="text-center space-y-4">
                                <h2 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white">Adversarial Threat Models</h2>
                                <p className="text-xl text-slate-600 dark:text-slate-400">How we mitigate state-level actors, malicious insiders, and infrastructure collapse.</p>
                            </div>

                            <div className="space-y-12">
                                <div className="bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 p-8 rounded-2xl flex flex-col md:flex-row gap-8">
                                    ...
                                    <div className="md:w-2/3 space-y-4">
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                                            <strong className="text-slate-900 dark:text-white block mb-1">The Threat:</strong> Hackers compromise our backend database (MongoDB) and gain access to all records.
                                        </p>
                                ...
                                <div className="bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 p-8 rounded-2xl flex flex-col md:flex-row gap-8">
                                    ...
                                    <div className="md:w-2/3 space-y-4">
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                                            <strong className="text-slate-900 dark:text-white block mb-1">The Threat:</strong> A node operator attempts to prematurely release your inheritance or steal your data.
                                        </p>
                                        <p className="text-emerald-700 dark:text-emerald-400 leading-relaxed text-sm bg-emerald-500/5 dark:bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/10 dark:border-emerald-500/20">
                                ...
                                <div className="bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 p-8 rounded-2xl flex flex-col md:flex-row gap-8">
                                    ...
                                    <div className="md:w-2/3 space-y-4">
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                                            <strong className="text-slate-900 dark:text-white block mb-1">The Threat:</strong> The core development team is coerced or physical servers are seized by authorities.
                                        </p>
                                        <p className="text-emerald-700 dark:text-emerald-400 leading-relaxed text-sm bg-emerald-500/5 dark:bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/10 dark:border-emerald-500/20">
