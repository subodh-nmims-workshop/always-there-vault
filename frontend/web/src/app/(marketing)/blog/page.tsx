...
export default function BlogPage() {
    ...
    const posts = [
        ...
        },
        {
            ...
            excerpt: "A technical comparison of immutable storage networks and why DeadMan Protocol utilizes IPFS with a pinning coalition for immediate availability, backed by Arweave for permanent archival persistence.",
            date: "Aug 30, 2026",
        ...
        <div className="min-h-screen bg-[#0a0c10] font-sans selection:bg-[#2b52ff]/30 selection:text-white flex flex-col relative overflow-hidden">
            ...
            <nav className="sticky top-0 z-50 bg-[#0a0c10]/80 backdrop-blur-xl border-b border-white/5 px-4 sm:px-8 py-4 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-3 group">
                    ...
                    <span className="font-bold text-xl tracking-tight hidden sm:block text-white">DeadMan Protocol</span>
                </Link>
