...
export default function CareersPage() {
    ...
    return (
        <div className="font-sans selection:bg-[#2b52ff]/30 selection:text-slate-900 dark:text-white relative overflow-hidden w-full bg-transparent text-slate-800 dark:text-slate-100">
