    ...
    <div className="min-h-screen bg-[#030712] text-slate-100 font-sans flex flex-col overflow-x-hidden relative">
      <nav className="fixed top-0 w-full z-50 bg-[#030712]/80 backdrop-blur-md border-b border-white/5 px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/investors" className="text-xs font-black uppercase tracking-[0.15em] text-slate-400 hover:text-white transition-colors">Partners & Investors</Link>
        ...
        <Link href="/">
          <button className="px-6 py-2.5 rounded-xl bg-white text-black text-xs font-black uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all">Back to Dashboard</button>
        </Link>
      </nav>
